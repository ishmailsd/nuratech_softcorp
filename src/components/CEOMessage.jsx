...
const CEOMessage = () => {
  return (
    <>
          {/* Section Header — glass and border only here */}
          <div className="text-center mb-16 bg-white/[0.06] backdrop-blur-xl border border-white/25 rounded-lg py-8 px-4">
            <h2 className="text-4xl font-bold text-gray-100 mb-4">A Message from Our CEO</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-10 gap-4">
            ...
            <div className="md:col-span-5 prose prose-lg">
              ...
              <div className="mt-8 not-prose">
                <p className="text-gray-100 font-semibold">Ishmail Sheriff Daoh</p>
                <p className="text-gray-300 text-base">Founder & CEO, Nura Tech Solutions</p>
                <p className="text-gray-300 text-base">Co-Founder & CEO, 360 SoftCorp</p>
              </div>
            </div>
          </div>
    </>
