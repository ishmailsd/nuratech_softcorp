  ...
  return (
    <div className="min-h-screen flex flex-col page-bg">
      ...
      <main className="flex-grow w-[100vw]">
        ...
        <section className="relative h-[80vh] w-full flex flex-col items-center justify-center text-center text-white px-4 pt-16 overflow-hidden">
          ...
          <div className="hero-bottom-line-concave-up mt-auto" aria-hidden="true" />
        </section>

        {/* Current Project — styled like Past Projects */}
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-center mb-12">
              <div className="glass-card rounded-lg py-3 px-6 w-fit">
                <h2 className="text-3xl font-bold text-gray-100">Current Project</h2>
              </div>
            </div>
            <div className="flex flex-col md:flex-row items-center gap-8">
               ...
               src={img1}
                alt="Online Store"
                className="w-full md:w-1/2 rounded-lg shadow-xl border border-white/20"
              />
              <div className="glass-card rounded-lg p-6 text-center md:text-left w-full md:w-1/2">
                <p className="text-lg text-gray-300">
                  We are currently developing an <span className="font-bold text-white">online food delivery application</span> that will revolutionize how customers connect with restaurants and food vendors.
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Previous Projects Section — top/bottom borders only, no glass */}
        <section className="py-16 section-top-bottom-borders text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-center mb-12">
              <div className="glass-card rounded-lg py-3 px-6 w-fit">
                <h2 className="text-3xl font-bold text-gray-100">Past Projects</h2>
              </div>
            </div>
            <div className="relative flex items-center justify-center">
              ...
              <button
                onClick={prevSlide}
                className="absolute left-4 md:left-10 top-1/2 transform -translate-y-1/2 glass-card p-3 rounded-full hover:bg-white/15 transition"
              >
                &#9664;
              </button>
              ...
              <button
                onClick={nextSlide}
                className="absolute right-4 md:right-10 top-1/2 transform -translate-y-1/2 glass-card p-3 rounded-full hover:bg-white/15 transition"
              >
                &#9654;
              </button>
            </div>
